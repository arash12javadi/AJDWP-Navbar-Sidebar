...
include_once(plugin_dir_path(__FILE__) . '/class-wp-bootstrap-navwalker.php');
//-------------------------------------------------------------------------//

register_nav_menus( [ 'AJDWPMenu2' => 'AJDWP Menu 2' ] );

//-------------------------------------------------------------------------//

if ( ! function_exists( 'plugin_AJDWP_primary_navigation_func' ) ) :
function plugin_AJDWP_primary_navigation_func() {
	wp_nav_menu( 
		array(  
			'theme_location' => 'AJDWPMenu2',
			'container'  => '',
...
add_action( 'AJDWP_primary_navigation', 'plugin_AJDWP_primary_navigation_func' );


function plugin_AJDWP_avatar_sm_func() {
    ?>
...
add_action( 'AJDWP_avatar_sm', 'plugin_AJDWP_avatar_sm_func' );

function plugin_AJDWP_avatar_func() {
    ?>
        <?php if(is_user_logged_in()){ $AJDWP_user_data = wp_get_current_user(); ?>
...
add_action( 'AJDWP_avatar', 'plugin_AJDWP_avatar_func' );




function plugin_AJDWP_search_modal_func() {
    ?>
...
add_action( 'AJDWP_search_modal', 'plugin_AJDWP_search_modal_func' );



function plugin_AJDWP_search_form_func() {
    ?>
...
add_action( 'AJDWP_search_form', 'plugin_AJDWP_search_form_func' );



function plugin_AJDWP_minicart_red_func() {
    ?>
...
add_action( 'AJDWP_minicart_red', 'plugin_AJDWP_minicart_red_func' );




function plugin_AJDWP_minicart_blue_func() {
    ?>
...
add_action( 'AJDWP_minicart_blue', 'plugin_AJDWP_minicart_blue_func' );
